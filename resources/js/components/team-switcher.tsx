...
export function TeamSwitcher() {
    ...
    const handleAddTeam = () => {
        setProcessing(true);
        router.post(route('team.store'), { name: teamName }, {
            onSuccess: () => {
                            ...
                            <DropdownMenuGroup>
                                ...
                                >
                                    ...
                                    <div className="font-medium">
                                        Add team <span className="text-xxs ml-1 bg-gray-900/50 py-0.5 px-1 font-mono text-white rounded-sm font-bold dark:text-gray-300 dark:bg-gray-700/80">PRO</span>
                                    </div>
                                </DropdownMenuItem>
                            </DropdownMenuGroup>
                        </DropdownMenuContent>
            ...
            <ResponsiveModal open={showAddTeamModal} onOpenChange={setShowAddTeamModal}>
                ...
                <DialogFooter className="mt-6">
                    ...
                    <Button
                        ...
                        disabled={!teamName.trim() || processing}
                    >

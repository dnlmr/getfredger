    ...
    public static function getSchema(): ObjectSchema
    {
        return new ObjectSchema(
            ...
            properties: [
                ...
                new NumberSchema('discount', description: 'The total discount amount applied to the subtotal. The value must be a positive integer (no decimal places). If the extracted value is negative, it should be converted to its absolute positive equivalent. For example, "100" for $1.00, and if "-$5.00" is extracted, it should be represented as "500".'),
